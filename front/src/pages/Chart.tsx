...
import { BarChart3, TrendingUp, PieChart, Activity, Thermometer, Droplets, Loader, AlertCircle } from 'lucide-react';

const Chart: React.FC = () => {
  const { sensors, loading, error } = useHistoricalData();
    ...
    return (
      <div className="min-h-screen p-6 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Récupération des données historiques des capteurs...</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="min-h-screen p-6 flex items-center justify-center">
        <div className="card p-8 bg-red-50 border border-red-200 max-w-md">
          <div className="text-center">
